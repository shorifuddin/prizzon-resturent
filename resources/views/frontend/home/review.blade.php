<section class="customer ptb">
    <div class="container">
        <div class="customer-inner">
            <div class="customer-top-bg"><img src="{{asset('frontend')}}/images/customer-top-bg.png" alt="customer"></div>
                ...
                <div class="customer-detail">
                    <div class="customer-img">
                        <div class="customer-img-in">
                            <img src="{{asset('frontend')}}/images/customer-1.png" alt="customer" class="customer-image">
            ...
            <div class="customer-bottom-bg"><img src="{{asset('frontend')}}/images/customer-bottom-bg.png" alt="customer"></div>
        </div>
    </div>
</section>
