        ...
        <div class="card-header bg-secondary card_header">
            <div class="row">
              <div class="col-md-8 card_header_title">
                <i class="md md-add-circle "></i> All Menus Information
              </div>
              <div class="col-md-4 card_header_btn ">
                <a href="{{ route('menus_add') }}" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="md md-view-module"></i> Add Menus</a>
              </div>
            </div>
        </div>
<br>
					...
					<table id="basic-datatable" class="table dt-responsive nowrap w-100">
						...
						<tbody>
							...
							<tr >
                                ...
                                <td>{{ Str::words($data->menus_details,5) }}</td>
								...
								<td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item" href="{{ route('menus_edit',$data->menus_id) }}">Edit</a>
                                            <a class="dropdown-item" href="{{ route('menus_view',$data->menus_id) }}">View</a>
                                            <a class="dropdown-item" href="{{ route('menus_softdelete',$data->menus_id) }}" data-bs-toggle="modal" data-bs-target="#dark-header-modal{{ $data->menus_id }}">Delete</a>
                                        </div>
                                    </div>
                                    </div>
                                </td>
                            ...
                            <!-- /.modal -->
                            <div id="dark-header-modal{{ $data->menus_id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="dark-header-modalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p>Are You Sure To Delete <b>{{ $data->menus_name }}</b>?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">No</button>
                                            <a href="{{ route('menus_softdelete',$data->menus_id) }}" class="btn btn-dark">Yes</a>
                                        </div>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                            </div>
