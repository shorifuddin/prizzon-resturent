...
<script>
swal({ title: "Good job!",text: "You clicked the button!", image: "success",timer:3000,});
</script>
@endif

@if (Session::has('error'))
<script>
swal({ title: "Good error!",text: "You clicked the button!", image: "error",});
</script>
@endif
        ...
        <div class="card-header bg-secondary card_header">
            <div class="row">
              <div class="col-md-8 card_header_title">
                <i class="md md-add-circle "></i> All Delete Menus Information
              </div>
                    ...
                    <div class="btn-group mb-2">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" style="">
                                <a class="dropdown-item" href="{{ route('menus_restore',$data->menus_id) }}">Restore</a>
                                <a class="dropdown-item" href="{{ route('menus_delete',$data->menus_id) }}" data-bs-toggle="modal" data-bs-target="#dark-header-modal">Delete</a>
                            </div>
                        </div>
                    </div>
                  </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('menus_delete',$data->menus_id) }}" class="btn btn-dark">Yes</a>
                            </div>
                        </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                </div>
