        ...
        <div class="card-header bg-secondary card_header">
            <div class="row">
              <div class="col-md-8 card_header_title">
                <i class="md md-add-circle "></i> All Chef Information
              </div>
              <div class="col-md-4 card_header_btn ">
                <a href="{{ route('chef_add') }}" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="md md-view-module"></i> Add Chef</a>
              </div>
            </div>
        </div>
<br>
								...
								<td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item" href="{{ route('chef_edit',$data->chef_id) }}">Edit</a>
                                            <a class="dropdown-item" href="{{ route('chef_view',$data->chef_id) }}">View</a>
                                            <a class="dropdown-item" href="{{ route('chef_softdelete',$data->chef_id) }}" data-bs-toggle="modal" data-bs-target="#dark-header-modal">Delete</a>
                                        </div>
                                    </div>
                                    </div>
                                </td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p>Are You Sure To Delete <b>{{ $data->chef_title }}</b>?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">No</button>
                                            <a href="{{ route('chef_softdelete',$data->chef_id) }}" class="btn btn-dark">Yes</a>
                                        </div>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                            </div>
