        ...
        <div class="card-header bg-secondary card_header">
            <div class="row">
              <div class="col-md-8 card_header_title">
                <i class="md md-add-circle "></i> Approved Reservation
              </div>
              <div class="col-md-4 card_header_btn ">
                <a href="{{ route('rtable_request') }}" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="md md-view-module"></i> Request Reservation</a>
              </div>
            </div>
        </div>
<br>
