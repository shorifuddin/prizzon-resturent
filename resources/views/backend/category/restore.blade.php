        ...
        <div class="card-header bg-secondary card_header">
            <div class="row">
              <div class="col-md-8 card_header_title">
                <i class="md md-add-circle "></i> All Delete Category Information
              </div>
              <div class="col-md-4 card_header_btn ">
                <a href="{{ route('category_all') }}" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="md md-view-module"></i> All Feature</a>
              </div>
            </div>
        </div>
                    ...
                    <div class="btn-group mb-2">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" style="">
                                <a class="dropdown-item" href="{{ route('category_restore',$data->category_id) }}">Restore</a>
                                <a class="dropdown-item" href="{{ route('category_delete',$data->category_id) }}" data-bs-toggle="modal" data-bs-target="#dark-header-modal">Delete</a>
                            </div>
                        </div>
                    </div>
                  </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('feature_delete',$data->category_id) }}" class="btn btn-dark">Yes</a>
                            </div>
                        </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                </div>
